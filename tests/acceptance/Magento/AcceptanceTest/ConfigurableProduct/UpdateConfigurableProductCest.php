<?php
namespace Magento\AcceptanceTest\Acceptance\ConfigurableProduct;

use Magento\AcceptanceTestFramework\Page\ConfigurableProduct\AdminConfigurableProductPage;
